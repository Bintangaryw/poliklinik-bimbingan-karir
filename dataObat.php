...
if (isset($_POST['save'])){
  ...
  if (!empty($_POST['id'])){
    $id_baru = $_POST['id'];
    $queri1 = mysqli_query($mysqli, "UPDATE obat SET 
        nama_obat='$namaobat_baru',
    ...
    $queri2 = mysqli_query($mysqli, "INSERT INTO 
        obat(nama_obat,kemasan,harga) VALUES(
...
if (isset($_GET['aksi'])) {
  ...
  $id = $_GET['id'];
  if ($aksi == 'hapus') {
    $queri3 = mysqli_query($mysqli, "DELETE FROM obat 
        WHERE id='$id'");
...
<head>
  ...
  <title>Data-Obat | Admin Poliklinik</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="dataObat.php" class="nav-link active">
          ...
          <div class="col-12">
            <form method="POST" class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Form Input Obat</h3>
              </div>
              <div class="card-body">
                <?php 
                $nama='';
                    ...
                    <tr>
                      ...
                      <td>
                          <a class="btn btn-info rounded-pill px-3" 
                              href="dataObat.php?id=<?php echo $row['id'] ?>">Ubah</a>
                          <a class="btn btn-danger rounded-pill px-3" 
                              href="dataObat.php?id=<?php echo $row['id']?>
                                  &aksi=hapus">Hapus</a>
                      </td>
                    </tr>
                  <?php }?>
